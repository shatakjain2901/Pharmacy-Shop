...
public class DB extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    {
        try{
                ...
                PreparedStatement stmt=con.prepareStatement("Create database PharmacyShop");
                stmt.executeUpdate();
                stmt=con.prepareStatement("use PharmacyShop");
                stmt.executeUpdate();
                stmt=con.prepareStatement("Create Table Medicines(mid int Primary Key,name varchar(20),description varchar(30),price int,qtyInStock int,Expiry Date,Photo varchar(20))");
                stmt.executeUpdate();
                ...
                for(int i=1;i<=20;i++)
                {
                    ...
                    stmt.setInt(1,100+i);
                    stmt.setString(2,"Medicine "+i);
                    stmt.setString(3,"Details of Medicine "+i);
                    stmt.setInt(4,price);
                    stmt.setInt(5,qty);
                    stmt.setString(6,"2017-7-"+dt);
                    stmt.setString(7,"m"+i+".jpg");
                    stmt.executeUpdate();
                }
